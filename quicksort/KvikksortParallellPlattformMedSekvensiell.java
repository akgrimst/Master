...
public class KvikksortParallellPlattformMedSekvensiell {
    ...
    int[] quickSort(int[] tallArray, int lav, int hoy) throws InterruptedException{
        ...
        if(hoy-lav > 10000){
            ...
            QuickSortTraad hoyTraad = new QuickSortTraad(tallArray, dreiepunkt+1, hoy);

            Thread ltrad = Thread.ofPlatform().start(lavTraad);
    ...
    public static void main(String[] args) {
        ...
        KvikksortParallellPlattformMedSekvensiell qss = new KvikksortParallellPlattformMedSekvensiell();
