...
public class KvikksortParallellPlattformHalvpartenTraader {
    ...
    public static void main(String[] args) {
        ...
        KvikksortParallellPlattformHalvpartenTraader qss = new KvikksortParallellPlattformHalvpartenTraader();
